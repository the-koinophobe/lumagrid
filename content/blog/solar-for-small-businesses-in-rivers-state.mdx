...
<style>{`
  ...
  .blog-img-hero { width: 100%; height: 320px; object-fit: cover; border-radius: 12px; display: block; margin: 1.75rem 0; }
  .blog-img-inline { width: 100%; height: 240px; object-fit: cover; border-radius: 10px; display: block; }
  figcaption { font-size: 0.8rem; color: var(--muted); text-align: center; margin-top: 0.5rem; line-height: 1.4; }
`}</style>